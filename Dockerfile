...
RUN LD_LIBRARY_PATH=/usr/lib/oracle/12.1/client64/lib yum install -y --enablerepo=remi-php55,remi php-fpm httpd mod_fcgid php-oci8 php-gd php-bcmath php-soap php-intl php-pecl-mongo php-pdo libaio tar
